...
hi Comment        ctermbg=black guibg=black ctermfg=darkgreen guifg=darkgreen cterm=bold gui=bold
hi Condtional     ctermbg=black guibg=black ctermfg=red guifg=red
hi Constant       ctermbg=black guibg=black ctermfg=red guifg=red
hi Cursor         ctermbg=black guibg=white ctermfg=white guifg=grey
...
hi Search         ctermbg=blue  guibg=blue  ctermfg=white guifg=white
